...
class ProjectCard(ctk.CTkFrame):
    def __init__(self, master, project: dict, on_remove, on_push, on_pull, on_log, on_purge, on_ghost, on_changes, on_gitignore, on_launcher=None, **kwargs):
        super().__init__(
